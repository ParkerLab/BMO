...
- [Installation](#installation)
  * [Create and activate BMO base environment](#create-and-activate-bmo-base-environment--optional-)
- [Running BMO](#running-bmo)
  * [Required input files](#required-input-files)
  * [Using Snakemake (recommended approach)](#using-snakemake-recommended-approach)
  ...
  * [Manually (standalone version, not recommended)](#manually--standalone-version-not-recommended)
...
[Chromatin information content landscapes inform transcription factor and DNA interactions. Nat Commun 12, 1307 (2021)](https://doi.org/10.1038/s41467-021-21534-4)
